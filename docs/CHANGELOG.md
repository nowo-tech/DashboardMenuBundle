...
[2.1.9]: https://github.com/nowo-tech/DashboardMenuBundle/releases/tag/v2.1.9

## [2.1.8] - 2026-08-20

### Documentation

- **UPGRADING.md:** `AllowAllMenuPermissionChecker` stays the item-level default (changing it would be breaking). Production hosts must assign `PermissionKeyAwareMenuPermissionChecker` (or a custom checker) **per menu** in the dashboard; the Flex recipe cannot switch stored menus.
...
[2.1.2]: https://github.com/nowo-tech/DashboardMenuBundle/releases/tag/v2.1.2
...
- [USAGE.md](USAGE.md) — theming via `--nowo-ui-*` tokens
- [UPGRADING.md](UPGRADING.md) — From 1.0.3 to 1.0.4
