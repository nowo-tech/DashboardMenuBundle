...
class MenuFixtures extends Fixture
{
    ...
    private function addSidebarItems(ObjectManager $manager, Menu $menu): void
    {
        ...
        $configuration = $this->item($menu, null, 5, 'Configuration', MenuItem::ITEM_TYPE_LINK, HomeController::APP_CONFIGURATION_ROUTE, [], MenuItem::LINK_TYPE_ROUTE, null, 'bootstrap-icons:sliders', null, ['en' => 'Configuration', 'es' => 'Configuración']);
        ...
        $status = $this->item($menu, null, 10, 'Status', MenuItem::ITEM_TYPE_LINK, HomeController::APP_INFO_ROUTE, ['section' => 'status'], MenuItem::LINK_TYPE_ROUTE, null, 'bootstrap-icons:activity', null, ['en' => 'Status', 'es' => 'Estado']);
