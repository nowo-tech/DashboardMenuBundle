#!/bin/sh
# Copy TypeScript assets from ts-assets-template to assets/ and remove old .js
# Run from demo/symfony8. Uses sudo if cp fails (e.g. assets/ owned by root from Docker).
