...
- PHP (Lines): **≥99%** on the includable `src/` set — see [`docs/COVERAGE.md`](docs/COVERAGE.md). Run `make coverage-check` / `composer coverage-check`.
